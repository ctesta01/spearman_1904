...
He covers some preliminarys on how to calculate correlation coefficients, including a method for **"elimiation of observational errors"** and **"elimination of irrelevant factors."** (It's in Chapter II that he introduces rank correlation).
...
-   Demerits:
    -   Though no fault of his own, the text can be a **bit clunky**, and I think that's because he didn't have the language we have now like "Let $X$ be a random variable."
