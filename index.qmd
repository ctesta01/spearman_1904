...
Ability in chess is often perceived as a stereotypical 
example of intelligence, but of course it's reasonable that 
a great chess player may be lacking in other areas of life 
such as social skills or emotional intelligence.

I'm not sure if we'll discuss "Emotional Intelligence" introduced 
by Salovey and Mayer in 1990, but it's worth thinking about 
where intelligence ends and other abilities begin as a limitation
of the philosophy expressed by Spearman behind the "g" factor. 
:::
...
After his introduction to the state of psychology and
prior work, Spearman lays out his analysis plan for 
data collected on school children's performance in **"discrimination"**
and **"intelligence"** tests. 

He covers some preliminarys on 
how to calculate correlation coefficients, including a
method for **"elimiation of observational errors"**
and **"elimination of irrelevant factors."** (It's in Chapter II that he 
introduces rank correlation).

For a series of experiments, he presents the results of his 
correlational analyses 
with particular emphasis on 1) *detrending for age*, and 2) 
investigating *which of the tests are correlated with each other*.

Finally, he concludes with an analysis of the **"General Intelligence"
factor**. 
...
Spearman collected the following data:
  ...
  - Experiment V, similar to experiment I with boys and girls, but aiming for **higher variation** 
...
## Intelligence Measures 
  ...
  - Teachers were asked to rank students based on their ["general impression"]{.emphasis}
  (e.g., based on if they seemed "bright", "average", "dull")
...
![](images/7_correlation.png){.absolute top='10%' left='15%' width='75%'}
![](images/7_correlation2.png){.absolute top='50%' left='15%' width='75%'}
...
# Results (intermangled with Interpretation)  {background-color="#1C5253" visibility="uncounted"}
...
:::{.fragment}
I'm not immediately sure about the distribution for Spearman's rank correlation 
coefficient, but Pearson's product-moment correlation has a known distribution.
:::

:::{.fragment}
The distribution for a sample correlation coefficient for correlated
random normal variables is a little bit crazy...
...
![](images/10_adjustment.png){.absolute top='10%' left='15%' width='75%'}
![](images/10_adjustment2.png){.absolute top='45%' left='15%' width='75%'}
